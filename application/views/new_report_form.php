	...
	<div class="graphs">
		...
		?>
			...
			<div class="tab-pane active" id="horizontal-form">
				<form class="form-horizontal" action="<?=base_url()?>index.php/admincustomer_controller/new_report" method="POST">
					<!-- Titulo -->
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">Título</label>
						<div class="col-sm-8">
							<input type="text" name="title_report" class="form-control1" id="focusedinput" placeholder="Título del informe...">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea name="description_report"  cols="50" rows="4" id="txtarea1" placeholder="Escriba aquí una descripción de la consulta realizada..."></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="checkbox-inline1"><label><input type="checkbox" name="active_report"> Activar/Desactivar visualización</label></div>
						</div>
					</div>
					...
					<div class="form-group has-warning">
				        <label for="selector1">
				        	SELECT
							<textarea cols="50" rows="4" name="query_report_select"></textarea>
							<br>
							WHERE
							<textarea cols="50" rows="2" name="query_report_where"></textarea>
				        </label>
				    </div>

				    <div class="form-group has-warning">
				        <label for="selector1">
				        	<input type="checkbox" name="query_report_groupby_active"></input>
				        	GROUP BY
							<input type="text" name="query_report_groupby"></input>
				        </label>
				    </div>

				     <div class="form-group has-warning">
				        <label for="selector1">
				        	<input type="checkbox" name="query_report_orderby_active"></input>
				        	ORDER BY
							<input type="text" name="query_report_orderby"></input>
				        </label>
				    </div>
