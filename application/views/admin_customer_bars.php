<?php
	if (isset($this->session->userdata['logged_in']) && $this->session->userdata['logged_in']['role'] == 'admin_customer') {
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="<?=base_url()?>index.php/admincustomer_controller/user_registration"><i class="lnr lnr-pencil"></i> <span>Registrar usuario</span></a></li>
						<li><a href="<?=base_url()?>index.php/admincustomer_controller/comments_options"><i class="lnr lnr-book"></i> <span>Comentarios</span></a></li>
						<li><a href="<?=base_url()?>index.php/admincustomer_controller/reports_form"><i class="lnr lnr-indent-increase"></i> <span>Informes</span></a></li>
					<ul>
